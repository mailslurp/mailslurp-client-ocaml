...
let create_inbox_ruleset ~inbox_id ~create_ruleset_options_t =
    let open Lwt in
...
let does_inbox_exist ~email_address ?allow_catch_all ?ip_address ?sender () =
    let open Lwt in
    ...
    let uri = Request.maybe_add_query_param uri "sender" (fun x -> x) sender in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Inbox_exists_dto.of_yojson) resp body

let does_inbox_have_automations () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/automations" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.handle_unit_response resp
...
let get_all_plus_addresses ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?inbox_id () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/plus-addresses" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
    let uri = Request.add_query_param uri "size" Int32.to_string size in
    ...
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Page_plus_address_projection.of_yojson) resp body

let get_all_scheduled_jobs ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?since ?before ?inbox_id () =
    let open Lwt in
...
let get_imap_smtp_access_servers () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/imap-smtp-access/servers" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Imap_smtp_access_servers.of_yojson) resp body
...
let get_inbox_emails_paginated ~inbox_id ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?since ?before ?sync_connectors () =
    let open Lwt in
    ...
    let uri = Request.maybe_add_query_param uri "since" (fun x -> x) since in
    let uri = Request.maybe_add_query_param uri "before" (fun x -> x) before in
    let uri = Request.maybe_add_query_param uri "syncConnectors" string_of_bool sync_connectors in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
...
let get_inbox_plus_address ~plus_address_id ~inbox_id =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/plus-addresses/{plusAddressId}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "plusAddressId"  plus_address_id in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Plus_address_dto.of_yojson) resp body

let get_inbox_plus_address_by_id ~plus_address_id ?inbox_id () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/plus-addresses/{plusAddressId}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "plusAddressId"  plus_address_id in
    let uri = Request.maybe_add_query_param uri "inboxId"  inbox_id in
...
let get_inbox_plus_address_emails ~plus_address ~inbox_id ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?since ?before () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/plus-addresses/emails" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let uri = Request.add_query_param uri "plusAddress" (fun x -> x) plus_address in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
    let uri = Request.add_query_param uri "size" Int32.to_string size in
    let uri = Request.add_query_param uri "sort" Enums.show_sortdirection sort in
    let uri = Request.maybe_add_query_param uri "since" (fun x -> x) since in
...
let get_inbox_plus_address_emails_for_plus_address_id ~plus_address_id ~inbox_id ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?since ?before () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "plusAddressId"  plus_address_id in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
...
let get_inbox_plus_addresses ~inbox_id ?(page = 0l) ?(size = 20l) ?(sort = `ASC) () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/plus-addresses" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
...
let get_inbox_sent_count ~inbox_id =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/sent/count" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
...
let get_inbox_tags ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?search_filter () =
    let open Lwt in
...
let get_inbox_tags_paginated ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?search_filter () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/tags/paginated" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
    let uri = Request.add_query_param uri "size" Int32.to_string size in
    ...
    let uri = Request.maybe_add_query_param uri "searchFilter" (fun x -> x) search_filter in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Page_inbox_tags.of_yojson) resp body

let get_inboxes ?(size = 100l) ?(sort = `ASC) ?since ?exclude_catch_all_inboxes ?before ?(_include = []) () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
...
let get_inboxes_by_tag ~tag ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?search_filter () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/tags/inboxes" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
    let uri = Request.add_query_param uri "size" Int32.to_string size in
...
let get_or_create_inbox_plus_address ~inbox_id ~full_address =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/plus-addresses/get-or-create" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let uri = Request.add_query_param uri "fullAddress" (fun x -> x) full_address in
    Cohttp_lwt_unix.Client.call `POST uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Plus_address_dto.of_yojson) resp body

let get_or_create_plus_address_by_full_address ~full_address =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/get-or-create-plus-address" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "fullAddress" (fun x -> x) full_address in
    Cohttp_lwt_unix.Client.call `POST uri ~headers >>= fun (resp, body) ->
...
let get_outboxes ?(page = 0l) ?(size = 20l) ?(sort = `ASC) () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/outboxes" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "page" Int32.to_string page in
    let uri = Request.add_query_param uri "size" Int32.to_string size in
...
let import_email_into_inbox ~inbox_id ~import_email_options_t =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/emails/import" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let body = Request.write_as_json_body Import_email_options.to_yojson import_email_options_t in
    Cohttp_lwt_unix.Client.call `POST uri ~headers ~body >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email.of_yojson) resp body

let import_email_into_inbox_bytes ~inbox_id ~body ?external_id ?(run_pipeline = false) ?(override_message_id = true) () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/emails/import/raw" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let uri = Request.maybe_add_query_param uri "externalId" (fun x -> x) external_id in
    let uri = Request.add_query_param uri "runPipeline" string_of_bool run_pipeline in
    let uri = Request.add_query_param uri "overrideMessageId" string_of_bool override_message_id in
    let body = Request.write_string_body  body in
    Cohttp_lwt_unix.Client.call `POST uri ~headers ~body >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email.of_yojson) resp body

let import_email_into_inbox_multipart ~inbox_id ~file ?external_id ?(run_pipeline = false) ?(override_message_id = true) () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/{inboxId}/emails/import/multipart" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "inboxId"  inbox_id in
    let uri = Request.maybe_add_query_param uri "externalId" (fun x -> x) external_id in
...
let is_email_address_available ~email_address =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/available" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.add_query_param uri "emailAddress" (fun x -> x) email_address in
    Cohttp_lwt_unix.Client.call `POST uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_available_result.of_yojson) resp body
...
let update_imap_access ~update_imap_access_options_t ?inbox_id () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/imap-access" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.maybe_add_query_param uri "inboxId"  inbox_id in
    let body = Request.write_as_json_body Update_imap_access_options.to_yojson update_imap_access_options_t in
...
let update_smtp_access ~update_smtp_access_options_t ?inbox_id () =
    let open Lwt in
    let uri = Request.build_uri "/inboxes/smtp-access" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.maybe_add_query_param uri "inboxId"  inbox_id in
    let body = Request.write_as_json_body Update_smtp_access_options.to_yojson update_smtp_access_options_t in
    Cohttp_lwt_unix.Client.call `PATCH uri ~headers ~body >>= fun (resp, body) ->
    Request.handle_unit_response resp
