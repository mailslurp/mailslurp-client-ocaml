...
val get_emails_paginated : ?inbox_id:string list -> ?page:int32 -> ?search_filter:string -> ?size:int32 -> ?sort:Enums.sortdirection -> ?unread_only:bool -> unit -> Page_email_projection.t Lwt.t
...
val get_organization_emails_paginated : ?inbox_id:string list -> ?page:int32 -> ?search_filter:string -> ?size:int32 -> ?sort:Enums.sortdirection -> ?unread_only:bool -> unit -> Page_email_projection.t Lwt.t
