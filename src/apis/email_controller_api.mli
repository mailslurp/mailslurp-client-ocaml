...
val download_attachment : email_id:string -> attachment_id:string -> ?api_key:string -> unit -> string list Lwt.t
...
val download_body_bytes : email_id:string -> string list Lwt.t
...
val get_attachments : email_id:string -> Attachment_meta_data.t list Lwt.t
...
val get_latest_email_in_inbox : inbox_id:string -> Email.t Lwt.t
...
val send_email_source_optional : send_email_options_t:Send_email_options.t -> ?inbox_id:string -> ?use_domain_pool:bool -> unit -> unit Lwt.t
