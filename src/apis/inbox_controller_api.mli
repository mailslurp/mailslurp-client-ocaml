...
val create_inbox : ?allow_team_access:bool -> ?description:string -> ?email_address:string -> ?expires_at:string -> ?expires_in:int64 -> ?favourite:bool -> ?name:string -> ?tags:string list -> ?use_domain_pool:bool -> unit -> Inbox.t Lwt.t
