...
val create_inbox_ruleset : inbox_id:string -> create_inbox_ruleset_options:Create_inbox_ruleset_options.t -> unit Lwt.t
...
val list_inbox_rulesets : inbox_id:string -> ?page:int32 -> ?search_filter:string -> ?size:int32 -> ?sort:Enums.sortdirection -> unit -> unit Lwt.t
