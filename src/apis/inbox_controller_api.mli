...
val get_emails : inbox_id:string -> ?delay_timeout:int64 -> ?limit:int32 -> ?min_count:int64 -> ?retry_timeout:int64 -> ?since:string -> ?size:int32 -> ?sort:Enums.sortdirection -> ?unread_only:bool -> unit -> Email_preview.t list Lwt.t
