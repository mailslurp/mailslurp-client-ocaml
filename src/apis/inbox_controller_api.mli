...
val create_inbox : ?email_address:string -> ?tags:string list -> ?name:string -> ?description:string -> ?use_domain_pool:bool -> ?favourite:bool -> ?expires_at:string -> ?expires_in:int64 -> ?allow_team_access:bool -> ?inbox_type:Enums.inboxtype -> unit -> Inbox_dto.t Lwt.t
...
val get_emails : inbox_id:string -> ?alias_for_limit__assessed_first_before_assessing_any_passed_limit_:int32 -> ?limit:int32 -> ?sort_the_results_by_received_date_and_direction_asc_or_desc:Enums.sortdirection -> ?retry_timeout:int64 -> ?delay_timeout:int64 -> ?min_count:int64 -> ?unread_only:bool -> ?before:string -> ?since:string -> unit -> Email_preview.t list Lwt.t
