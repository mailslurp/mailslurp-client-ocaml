...
val create_inbox : ?email_address:string -> ?tags:string list -> ?name:string -> ?description:string -> ?use_domain_pool:bool -> ?favourite:bool -> ?expires_at:string -> ?expires_in:int64 -> ?allow_team_access:bool -> ?inbox_type:Enums.inboxtype -> ?virtual_inbox:bool -> ?use_short_address:bool -> unit -> Inbox_dto.t Lwt.t
