...
val create_webhook_for_ai_transformer : transformer_id:string -> create_webhook_options_t:Create_webhook_options.t -> Webhook_dto.t Lwt.t
...
val get_all_webhook_results : ?page:int32 -> ?size:int32 -> ?sort:Enums.sortdirection -> ?search_filter:string -> ?since:string -> ?before:string -> ?unseen_only:bool -> ?result_type:Enums.resulttype -> ?event_name:Enums.eventname -> ?min_status_code:int32 -> ?max_status_code:int32 -> ?inbox_id:string -> ?sms_id:string -> ?attachment_id:string -> ?email_id:string -> ?phone_id:string -> ?ai_transformer_id:string -> unit -> Page_webhook_result.t Lwt.t
val get_all_webhooks : ?page:int32 -> ?size:int32 -> ?sort:Enums.sortdirection -> ?search_filter:string -> ?since:string -> ?inbox_id:string -> ?ai_transformer_id:string -> ?phone_id:string -> ?before:string -> ?health:Enums.healthstatus -> ?event_type:Enums.eventname -> ?url:string -> ?event_type_source:Enums.eventtypesource -> ?include_account_wide:bool -> unit -> Page_webhook_projection.t Lwt.t
val get_inbox_webhooks_paginated : inbox_id:string -> ?page:int32 -> ?size:int32 -> ?sort:Enums.sortdirection -> ?search_filter:string -> ?since:string -> ?before:string -> ?health:Enums.healthstatus -> ?event_type:Enums.eventname -> ?include_account_wide:bool -> unit -> Page_webhook_projection.t Lwt.t
...
val get_phone_number_webhooks_paginated : phone_id:string -> ?page:int32 -> ?size:int32 -> ?sort:Enums.sortdirection -> ?since:string -> ?before:string -> ?event_type:Enums.eventname -> ?search_filter:string -> ?health:Enums.healthstatus -> ?include_account_wide:bool -> unit -> Page_webhook_projection.t Lwt.t
...
val get_test_webhook_payload_new_ai_transform_result : unit -> Webhook_new_ai_transform_result_payload.t Lwt.t
...
val update_webhook : webhook_id:string -> create_webhook_options_t:Create_webhook_options.t -> ?inbox_id:string -> ?ai_transformer_id:string -> ?phone_number_id:string -> ?override_auth:bool -> unit -> Webhook_dto.t Lwt.t
