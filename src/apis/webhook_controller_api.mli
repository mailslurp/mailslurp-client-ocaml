...
val delete_all_webhooks : unit -> unit Lwt.t
...
val get_all_webhooks : ?page:int32 -> ?size:int32 -> ?sort:Enums.sortdirection -> ?search_filter:string -> ?since:string -> ?before:string -> unit -> Page_webhook_projection.t Lwt.t
...
val get_webhook_results_unseen_error_count : inbox_id:string -> Unseen_error_count_dto.t Lwt.t
