...
val get_all_webhook_results : ?before:string -> ?page:int32 -> ?search_filter:string -> ?since:string -> ?size:int32 -> ?sort:Enums.sortdirection -> ?unseen_only:bool -> unit -> Page_webhook_result.t Lwt.t
val get_all_webhooks : ?before:string -> ?page:int32 -> ?search_filter:string -> ?since:string -> ?size:int32 -> ?sort:Enums.sortdirection -> unit -> Page_webhook_projection.t Lwt.t
val get_inbox_webhooks_paginated : inbox_id:string -> ?before:string -> ?page:int32 -> ?search_filter:string -> ?since:string -> ?size:int32 -> ?sort:Enums.sortdirection -> unit -> Page_webhook_projection.t Lwt.t
...
val get_webhook_results : webhook_id:string -> ?before:string -> ?page:int32 -> ?search_filter:string -> ?since:string -> ?size:int32 -> ?sort:Enums.sortdirection -> ?unseen_only:bool -> unit -> Page_webhook_result.t Lwt.t
