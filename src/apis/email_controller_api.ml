...
let check_email_audit1 ~email_id =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/check-email-audit" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
...
let check_email_body ~email_id =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/check-email-body" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    Cohttp_lwt_unix.Client.call `POST uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Check_email_body_results.of_yojson) resp body
...
let create_email_audit_for_email ~email_id =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/audit" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    Cohttp_lwt_unix.Client.call `POST uri ~headers >>= fun (resp, body) ->
...
let get_email_codes ~email_id ~extract_codes_options_t () =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/codes" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let body = Request.write_as_json_body Extract_codes_options.to_yojson extract_codes_options_t in
    Cohttp_lwt_unix.Client.call `POST uri ~headers ~body >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Extract_codes_result.of_yojson) resp body
...
let get_email_content_part ~email_id ~content_type ?strict ?index () =
    let open Lwt in
    ...
    let uri = Request.maybe_add_query_param uri "strict" string_of_bool strict in
...
let get_email_content_part_content ~email_id ~content_type ?strict ?index () =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/contentPart/raw" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let uri = Request.add_query_param uri "contentType" (fun x -> x) content_type in
...
let get_email_html ~email_id ?(replace_cid_images = false) () =
    let open Lwt in
...
let get_email_html_json ~email_id ?(replace_cid_images = false) () =
    let open Lwt in
...
let get_email_links ~email_id ?selector () =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/links" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let uri = Request.maybe_add_query_param uri "selector" (fun x -> x) selector in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
...
let get_email_screenshot_as_base64 ~email_id ~get_email_screenshot_options_t =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/screenshot/base64" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let body = Request.write_as_json_body Get_email_screenshot_options.to_yojson get_email_screenshot_options_t in
    Cohttp_lwt_unix.Client.call `POST uri ~headers ~body >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_screenshot_result.of_yojson) resp body

let get_email_screenshot_as_binary ~email_id ~get_email_screenshot_options_t =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/screenshot/binary" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let body = Request.write_as_json_body Get_email_screenshot_options.to_yojson get_email_screenshot_options_t in
...
let get_email_signature ~email_id =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/signature" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_signature_parse_result.of_yojson) resp body

let get_email_summary ~email_id ?decode () =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/summary" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
    let uri = Request.maybe_add_query_param uri "decode" string_of_bool decode in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_preview.of_yojson) resp body
...
let get_email_thread ~thread_id =
    let open Lwt in
    let uri = Request.build_uri "/emails/threads/{threadId}" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "threadId"  thread_id in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_thread_dto.of_yojson) resp body

let get_email_thread_items ~thread_id ?(sort = `ASC) () =
    let open Lwt in
    let uri = Request.build_uri "/emails/threads/{threadId}/items" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "threadId"  thread_id in
    let uri = Request.add_query_param uri "sort" Enums.show_sortdirection sort in
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Email_thread_items_dto.of_yojson) resp body

let get_email_threads ?html_selector ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?search_filter ?since ?before () =
    let open Lwt in
    let uri = Request.build_uri "/emails/threads" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.maybe_add_query_param uri "htmlSelector"  html_selector in
    ...
    Cohttp_lwt_unix.Client.call `GET uri ~headers >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Page_email_thread_projection.of_yojson) resp body

let get_emails_offset_paginated ?(inbox_id = []) ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?(unread_only = false) ?search_filter ?since ?before ?favourited ?sync_connectors ?plus_address_id ?(_include = []) () =
    let open Lwt in
    ...
    let uri = Request.maybe_add_query_param uri "since" (fun x -> x) since in
    let uri = Request.maybe_add_query_param uri "before" (fun x -> x) before in
    let uri = Request.maybe_add_query_param uri "favourited" string_of_bool favourited in
    let uri = Request.maybe_add_query_param uri "syncConnectors" string_of_bool sync_connectors in
    let uri = Request.maybe_add_query_param uri "plusAddressId"  plus_address_id in
...
let get_emails_paginated ?(inbox_id = []) ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?(unread_only = false) ?search_filter ?since ?before ?sync_connectors ?plus_address_id ?favourited () =
    let open Lwt in
    let uri = Request.build_uri "/emails" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
...
let get_organization_emails_paginated ?(inbox_id = []) ?(page = 0l) ?(size = 20l) ?(sort = `ASC) ?(unread_only = false) ?search_filter ?since ?before ?sync_connectors ?favourited ?plus_address_id () =
    let open Lwt in
...
let get_unread_email_count ?inbox_id () =
    let open Lwt in
...
let mark_all_as_read ?(read = true) ?inbox_id () =
    let open Lwt in
    let uri = Request.build_uri "/emails/read" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
...
let search_emails ~search_emails_options_t ?sync_connectors ?favourited ?plus_address_id () =
    let open Lwt in
    let uri = Request.build_uri "/emails/search" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.maybe_add_query_param uri "syncConnectors" string_of_bool sync_connectors in
    let uri = Request.maybe_add_query_param uri "favourited" string_of_bool favourited in
    let uri = Request.maybe_add_query_param uri "plusAddressId"  plus_address_id in
    let body = Request.write_as_json_body Search_emails_options.to_yojson search_emails_options_t in
    Cohttp_lwt_unix.Client.call `POST uri ~headers ~body >>= fun (resp, body) ->
    Request.read_json_body_as (JsonSupport.unwrap Page_email_projection.of_yojson) resp body
...
let set_email_favourited ~email_id ~favourited =
    let open Lwt in
    let uri = Request.build_uri "/emails/{emailId}/favourite" in
    let headers = Request.default_headers in
    let headers = Cohttp.Header.add headers "x-api-key" Request.api_key in
    let uri = Request.replace_path_param uri "emailId"  email_id in
