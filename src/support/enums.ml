...
type createinboxforwarderoptions_field = [
...
let createinboxforwarderoptions_field_of_yojson json = createinboxforwarderoptions_field_of_yojson (`List [json])
let createinboxforwarderoptions_field_to_yojson e =
    match createinboxforwarderoptions_field_to_yojson e with
    | `List [json] -> json
    | json -> json
