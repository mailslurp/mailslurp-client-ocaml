...
let usertype_of_yojson json = usertype_of_yojson (`List [json])
let usertype_to_yojson e =
    match usertype_to_yojson e with
    | `List [json] -> json
    | json -> json
...
let verified_of_yojson json = verified_of_yojson (`List [json])
let verified_to_yojson e =
    match verified_to_yojson e with
    | `List [json] -> json
    | json -> json
...
type webhooktestrequest_method = [
...
let webhooktestrequest_method_of_yojson json = webhooktestrequest_method_of_yojson (`List [json])
let webhooktestrequest_method_to_yojson e =
    match webhooktestrequest_method_to_yojson e with
    | `List [json] -> json
    | json -> json
