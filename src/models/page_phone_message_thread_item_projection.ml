 ...
 *
 * Schema Page_phone_message_thread_item_projection.t : Paginated phone message thread items. These are messages in a phone thread. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.
 *)

type t = {
    content: Phone_message_thread_item_projection.t list;
