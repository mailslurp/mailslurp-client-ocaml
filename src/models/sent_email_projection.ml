...
(** Collection of items *)
let create (id : string) (user_id : string) (attachments : string list) (created_at : string) (inbox_id : string) (_to : string list) (bcc : string list) (cc : string list) (virtual_send : bool) : t = {
    id = id;
    from = None;
    user_id = user_id;
    subject = None;
