...
(** Collection of items *)
let create (inbox_id : string) (id : string) (user_id : string) (attachments : string list) (created_at : string) (_to : string list) (bcc : string list) (cc : string list) (virtual_send : bool) : t = {
    inbox_id = inbox_id;
    id = id;
    from = None;
    subject = None;
