...
let create (id : string) (user_id : string) (basic_auth : bool) (url : string) (_method : Enums.webhookdto_method) (payload_json_schema : string) (created_at : string) (updated_at : string) : t = {
    id = id;
    user_id = user_id;
