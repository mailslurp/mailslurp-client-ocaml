 ...
 *
 * Schema Page_unknown_missed_email_projection.t : Paginated unknown MissedEmail results. Unknown missed emails are emails that were sent to MailSlurp /Page index starts at zero. Projection results may omit larger entity fields. For fetching a full entity use the projection ID with individual method calls.
 *)

type t = {
    content: Unknown_missed_email_projection.t list;
