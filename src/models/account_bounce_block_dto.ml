...
let create (is_frozen : bool) (is_sending_blocked : bool) (bounce_count : int64) (bounce_count_today : int64) (maximum_daily_bounces : int64) (maximum_account_bounces : int64) : t = {
    is_frozen = is_frozen;
