...
type t = {
    ...
    imap_uid: int64 option [@default None];
...
let create (id : string) (from : string option) (inbox_id : string) (created_at : string) (_to : string list) (read : bool) (team_access : bool) : t = {
    id = id;
    thread_id = None;
    from = from;
    subject = None;
