 ...
 *
 * Schema Page_organization_inbox_projection.t : Paginated organization inbox results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.
 *)

type t = {
    content: Organization_inbox_projection.t list;
