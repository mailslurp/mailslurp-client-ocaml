...
let create (email_address : string) (secure_smtp_server_host : string) (secure_smtp_server_port : int32) (secure_smtp_username : string) (secure_smtp_password : string) (smtp_server_host : string) (smtp_server_port : int32) (smtp_username : string) (smtp_password : string) (secure_imap_server_host : string) (secure_imap_server_port : int32) (secure_imap_username : string) (secure_imap_password : string) (imap_server_host : string) (imap_server_port : int32) (imap_username : string) (imap_password : string) (imap_mailbox : string) : t = {
