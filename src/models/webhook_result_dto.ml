...
let create (user_id : string) (webhook_id : string) (webhook_url : string) (message_id : string) (http_method : Enums.webhookdto_method) (webhook_event : Enums.eventname) (response_time_millis : int64) (created_at : string) (updated_at : string) : t = {
    id = None;
    user_id = user_id;
    inbox_id = None;
