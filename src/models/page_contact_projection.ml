 ...
 *
 * Schema Page_contact_projection.t : Paginated contact results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.
 *)

type t = {
    content: Contact_projection.t list;
